...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('[SEED] [OK] Super Admin : admin@esante-benin.com'))
    ...
    def _insert_test_data(self, services):
        ...
        med2 = self._create_user(
            email='dr.amina@esante-benin.com', 
        ...
        med3 = self._create_user(
            email='dr.brice@esante-benin.com', 
        ...
        lab1 = self._create_user(
            email='labo.cotonou@esante-benin.com', 
        ...
        lab2 = self._create_user(
            email='labo.portonovo@esante-benin.com', 
        ...
        # Admin CHU Cotonou
        self._create_user(
            email='admin.chu@esante-benin.com', 
